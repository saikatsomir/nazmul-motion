...
const services = [
  {
    ...
    desc: 'Turn stories into motion that sells ideas.',
  },
  {
    title: 'SaaS Explainers',
    desc: 'Animate user flows, dashboards, and product journeys.',
  },
  {
    title: 'Product Motions',
    desc: 'Make app and website interactions come to life.',
    highlight: true,
  },
  {
    title: 'Lottie & Web Motion',
    desc: 'Bring your work to websites and apps with code-ready animations.',
  },
];
...
export const Learn = () => {
  ...
  return (
    <section className="bg-[#0a0612] text-white pb-44 px-6 md:px-20 relative z-40">
      <div className="absolute w-[400px] h-[600px] bg-[#11032a] blur-[100px] right-0 -top-20 z-50" />
      <div className="absolute w-[300px] h-[500px] bg-[#11032a] blur-[100px] -left-20 top-20 -z-10" />
      <div className="absolute w-[300px] h-[500px] bg-[#11032a] blur-[100px] -translate-1/2 left-1/2 top-[50%] -z-10" />

      <div className="max-w-[1340px] mx-auto flex items-center gap-10 ">
        {/* Left Content */}
        <div className="w-[30%]">
          ...
          <button
            style={{
              background:
                'linear-gradient(90deg,rgba(70, 36, 138, 1) 0%, rgba(23, 7, 59, 1) 90%)',
            }}
            className="text-white font-medium text-lg cursor-pointer w-52 h-12 mt-8 border border-gray-800 rounded-full flex justify-center items-center gap-3"
          >
        ...
        {/* Right Side Cards */}
        <div className="relative w-[70%] z-50">
          ...
          <div className="space-y-4 relative z-10">
            {services.map((item, index) => (
              <div
                ...
                className="p-6 rounded-2xl border border-gray-800 flex gap-5 items-center cursor-pointer transition duration-500 hover:bg-linear-to-r hover:from-purple-700 hover:to-purple-950"
              >
